...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jlbquanlynhanvien.setFont(new java.awt.Font("Segoe UI", 0, 22)); // NOI18N
        jlbquanlynhanvien.setForeground(new java.awt.Color(255, 255, 255));
        jlbquanlynhanvien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/QuanLyThuVien/images/icon_menu0_white_24dp.png"))); // NOI18N
        jlbquanlynhanvien.setText("QUẢN LÝ TÀI KHOẢN");
        jlbquanlynhanvien.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jlbquanlynhanvienMouseClicked(evt);
            }
        });
        jPanel35.add(jlbquanlynhanvien, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 280, 60));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 1020, 610));
    ...
    private void jlbquanlynhanvienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jlbquanlynhanvienMouseClicked
        ManageUsersFrame muf = new ManageUsersFrame();
        muf.setVisible(true);
        muf.pack();
        muf.setLocationRelativeTo(null);
        muf.setResizable(false);
        this.dispose();
    }//GEN-LAST:event_jlbquanlynhanvienMouseClicked
