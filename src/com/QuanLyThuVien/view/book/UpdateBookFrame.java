...
public class UpdateBookFrame extends javax.swing.JFrame {
    ...
    public UpdateBookFrame(int bookId) {
        ...
        txt_bookID.setText(String.valueOf(book.getBook_id()));
        txt_author.setText(book.getAuthor());
        txt_title.setText(book.getTitle());
        txt_amount.setText(String.valueOf(book.getAmount()));
        txt_Introduce.setText(book.getIntroduce());
        ...
        jComboBox_category.setSelectedIndex(index);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(txt_bookID, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 110, 240, -1));
        ...
        jPanel1.add(txt_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 180, 240, -1));
        ...
        jPanel1.add(txt_author, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 250, 240, -1));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 310, -1, 30));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel9.setText("Choose Book Category");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 300, -1, -1));

        txt_amount.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanel1.add(txt_amount, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 390, 240, -1));

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/QuanLyThuVien/images/icons8_Unit_26px.png"))); // NOI18N
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 390, -1, -1));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 430, -1, 40));

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel13.setText("Enter Book Introduce");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 430, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 450, 240, 130));
        ...
        jPanel1.add(jComboBox_category, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 320, 240, -1));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel1.setText("UPDATE BOOK FRAME");
        ...
        jPanel1.add(btn_back, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 600, 90, 50));
        ...
        jPanel1.add(btn_update, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 600, 90, 50));
